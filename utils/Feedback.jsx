  ...
  return (
    <Fragment>
      ...
      >
        ...
        >
          <h3 className='text-center text-2xl font-bold dark:text-[#2ecc71] text-[#2ecc71]'>
            Feedback
          </h3>
          <p>As a developer, you understand the importance of feedback.</p>
          <input
            className='dark:bg-black border dark:border-[#2ecc71] border-[#2ecc71] p-2 rounded'
            id='name'
            name='name'
          ...
          <div className='flex justify-between'>
            <button
              className='font-bold px-4 text-white dark:bg-[#0ab0c2] disabled:cursor-default p-2 rounded dark:hover:bg-[#078795] bg-[#f91071] hover:bg-[#2ecc71]'
              onClick={() => {
                setShowModal(false);
                setFormData({});
              }}
