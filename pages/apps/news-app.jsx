      ...
      <Theme>
        ...
        <div className="dark:bg-gray-900 min-h-[92vh]">
          <div className="text-3xl font-bold text-center pt-5 flex items-center justify-center gap-8">
            News App
            <button
              className="p-3 dark:bg-[#0ab0c2] bg-[#2ecc71] text-white font-extrabold rounded-full w-10 h-10 flex items-center justify-center"
...
const Filters = ({
  ...
  return (
    ...
    >
      ...
      <button
        className="dark:bg-[#0ab0c2] bg-[#2ecc71] text-white rounded p-1 px-3 text-sm font-bold"
        onClick={loadNews}
      >
        Load News
      </button>
