    ...
    <Fragment>
      ...
      <Theme>
        ...
        <div className="md:px-[20%] px-[3%] dark:bg-gray-900 min-h-[92vh]">
          ...
          <div className="mt-8">
            ...
            <div className="w-fit m-auto my-4">
              ...
              <button
                className="p-2 px-5 dark:bg-[#286969] bg-[#2ecc71] text-white font-bold rounded hidden sm:inline sm:ml-5"
        ...
        <div className="sm:hidden flex justify-center w-[100%] fixed bottom-10">
          <button
            className="p-2 px-5 dark:bg-[#286969] bg-[#2ecc71] text-white rounded sm:ml-5"
            onClick={translateFun}
          >
            Translate
          </button>
