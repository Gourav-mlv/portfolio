...
const Intro = () => {
  ...
  return (
    <Fragment>
      <Head>
        <title>Gourav&apos;s Portfolio</title>
      </Head>
      <section id='home'>
        <div
          ...
          >
            ...
            <div className='mt-5 md:mt-10 flex gap-3'>
              ...
              <Link
                ...
                href={'https://www.linkedin.com/in/gouravmalviya7/'}
              >
                Hire me
              </Link>
              ...
              <Link
                ...
                href='https://drive.google.com/drive/folders/1OyF_i3iKPSfddP_PN0lH63--lu5paHtz?usp=drive_link'
                target='_blank'
              >
                Download Resume
              </Link>
